...
INSERT INTO students (first_name, last_name, email, date_of_birth, department_id, 
enrollment_year) VALUES
  ('Cynthia',  'Mehul',    'cynthia.mehul@college.edu',    '2005-03-28', 1, 2023),
  ('Aaron',  'Kurapati',   'aaron.kurapati@college.edu',   '2005-12-28', 1, 2023);
...
-- 24) 
SELECT enrollment_year, COUNT(*) AS count_of_students 
FROM students 
...
-- 28) 
SELECT e.course_id, COUNT(*) AS count_of_students 
FROM students s 
LEFT JOIN enrollments e ON s.student_id=e.student_id 
GROUP BY course_id;
...
-- 31) 
SELECT d.dept_name, ROUND(AVG(p.salary),2) AS avg_salary_per_dept 
FROM departments d 
...
-- 34)
SELECT d.department_id, d.dept_name, COUNT(e.student_id) 
FROM departments d 
